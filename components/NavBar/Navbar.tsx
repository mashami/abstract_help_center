...
const Navbar = () => {
  ...
  return (
    <nav
      className={`flex bg-black w-full text-white z-0 items-center  md:px-[30px] h-[88px] `}
    >
      <div className="md:mx-[54px] mx-5 my-[19px] md:items-center flex md:justify-between items-center sm:items-center w-full">
        <div className="grid grid-cols-2  ">
          ...
          <Link
            className="border-l-2 pl-3 pb-1 lg:pt-[2px] pt-0 lg:mx-0 mx-2  lg:text-2xl text-[17px] font-bold flex justify-center items-center font-gt-america lg:text-bottonFontSize"
            href=""
          >
            Help Center
          </Link>
        ...
        <div className="hidden xl:flex items-center gap-4 font-gt-america ">
          <div>
            <Button variant="outline" text="Submit a request" />
          </div>
          <div>
            <Button variant="fill" text="Sign in" />
          </div>
        </div>
      </div>
